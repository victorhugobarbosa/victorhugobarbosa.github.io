                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[#111] aspect-video hover:border-neon-green/50 transition-colors duration-300 h-full">
                                    {/* Browser Header */}
